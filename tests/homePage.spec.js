...
test.describe('homePage.spec', () => {
	...
	test('ТС 03.1.63 Verify that the information block has the header', async ({ page }) => {
		...
		await expect(homePage.scienceMeetsPerformanceSectionInfBlockHeader).toHaveText(SCIENCE_MEETS_PERFORMANCE_HEADER_TEXT);
